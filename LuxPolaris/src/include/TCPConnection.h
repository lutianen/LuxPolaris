...
namespace Polaris {
    ...
    private:
        ...
        void
        sendInLoop(const StringPiece& message);
        void
        sendInLoop(const void* message, size_t len);
        void
        shutdownInLoop();
    ...
    public:
        ...
        void
        send(const void* message, int len);
        void
        ...
        inline void
        setContext(const Lux::any& context) {
            context_ = context;
        }

        inline const Lux::any&
        getContext() const {
            return context_;
        }
        ...
        void
        connectEstablished(); // should be called only once
        // called when TcpServer has removed me from its map
        void
        connectDestroyed(); // should be called only once
    };
