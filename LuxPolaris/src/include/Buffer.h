...
namespace Polaris {
    ...
    /// @endcode
    class Buffer : public Lux::copyable {
    public:
        ...
        inline const char*
        findCRLF(const char* start) const {
            assert(peek() <= start);
        ...
        inline const char*
        findEOL(const char* start) const {
            assert(peek() <= start);
            assert(start <= beginWrite());
        ...
        inline void
        append(const char* /*restrict*/ data, size_t len) {
        ...
        inline void
        append(const void* /*restrict*/ data, size_t len) {
        ...
        inline void
        prepend(const void* /*restrict*/ data, size_t len) {
