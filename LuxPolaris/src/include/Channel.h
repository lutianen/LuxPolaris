...
namespace Polaris {
     ...
     *  The file descriptor could be a socket, an eventfd, a timerfd or signalfd.
     * 只负责一个文件描述符，对不同的服务、不同的事件类型，
    ...
    public:
        ...
        // for debug
        std::string
        reventsToString() const;
        std::string
        eventsToString() const;
